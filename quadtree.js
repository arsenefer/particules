...
//         c.setAttribute('cx', x); // svg's circle center
//         c.setAttribute('cy', y);
//         c.setAttribute('r', 2);
//         svg.append(c)
...
//     let range = new Circle(loc.x, loc.y, 100/2,100/2)
//     let c = document.createElementNS(svgNS, 'circle');
//     c.setAttribute('cx', loc.x); // svg's circle center
//     c.setAttribute('cy', loc.y);
//     c.setAttribute('r', 50);
//     c.setAttribute('fill', 'none')
//     c.setAttribute('stroke', 'rgb(255,0,255)');
//     svg.append(c)
//     let seen = qt.query(range);
//     for (let point of seen){

//         svg.children[point.userData].setAttribute('fill','pink');
//     }
//     },false);
//     }
// }
